  ...
  return (
    <div className="space-y-8 font-mono">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button className="flex items-center gap-2 px-6 py-3 bg-[#EBBB54] text-black font-black rounded-xl hover:scale-105 transition-all shadow-xl shadow-[#EBBB54]/10 uppercase text-xs">
          <Plus size={18} />
      ...
      <div className="bg-black border border-white/5 p-4 rounded-2xl flex flex-col md:flex-row gap-4 items-center">
        <div className="relative flex-1 w-full group">
          ...
          <input 
            type="text" 
            placeholder="FILTER_BY_NAME_OR_DESC..." 
            value={search}
          ...
          filteredPrograms.map((program) => (
            <div key={program._id} className="bg-black border border-white/5 hover:border-white/20 p-6 rounded-2xl transition-all group flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white group-hover:text-[#EBBB54] transition-colors uppercase tracking-tight">{program.name}</h3>
              ...
              <div className="flex items-center gap-3">
                 <button className="px-4 py-2 border border-white/10 text-[10px] font-black uppercase tracking-widest hover:bg-white/5 transition-all flex items-center gap-2">
                    <Edit2 size={14} /> EDIT
                 </button>
                 <button className="px-4 py-2 border border-red-500/10 text-red-500 text-[10px] font-black uppercase tracking-widest hover:bg-red-500/5 transition-all flex items-center gap-2">
