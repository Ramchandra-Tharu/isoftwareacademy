  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 font-mono pb-20">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-black text-white tracking-tighter uppercase">DEPLOY_<span className="text-[#EBBB54]">PROGRAM</span></h1>
          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em]">Create a structured learning path</p>
        </div>
      </div>
